    ...
    return (
        ...
        <div ref={targetRef} className="footer-container">
            <div className="footer-headings">
                ...
                <a href='https://chat.whatsapp.com/C551a1rsjAeCFhO6glWPIb' target="_blank" rel="noreferrer"><div className="footer-whatsapp" onClick={()=>window.fbq('track', ' AddtoWhatsapp')}>
