...
const Success = () => {
  return (
    <div className="succ-cont">
      <div className="succ-sub-cont">
        <div className="succ-head">Welcome to</div>
        <div className="succ-logo">
          <img src={logo} alt="Logo" />
        </div>
        <div className="succ-hack">Hackathon’23 </div>
        <div className="succ-text">
