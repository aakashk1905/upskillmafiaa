...
function RedirectComponent() {
  ...
  useEffect(() => {
    if (width >= 800) {
      ...
      else window.location.href = `https://cosmos.video/v/6qqo-919q-tsug/office`;
    }
  }, [width, room]);
...
function RedirectComponentE2() {
  ...
  useEffect(() => {
    if (width >= 800) {
      if (room) window.location.href = `https://cosmos.video/v/h8tj-5ba4-9p8c/office/r/${room}`
      else window.location.href = `https://cosmos.video/v/h8tj-5ba4-9p8c/office`;
    }
  }, [width, room]);
  if (width < 800) {
    return (<>
...
function RedirectComponent2() {
  ...
  useEffect(() => {
    if (width >= 800)
      window.location.href = "https://cosmos.video/v/6qqo-919q-tsug/office/r/stage";
  }, [width]);
  if (width < 800) {
    return (<>
      <div className='mobile-error-cont'>
