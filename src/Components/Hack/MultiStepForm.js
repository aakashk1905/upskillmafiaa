...
const MultiStepForm = ({setShowForm}) => {
  ...
  const submitFormData = async () => {
    try {
      const response = await fetch('https://api.tutedude.com/lms/hackathon/form', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        body: JSON.stringify({ currentStep, teamName, numMembers, teamMembers }),
      });

      if (response.status === 201) {
        console.log('Form data saved successfully');
        alert('Registered successfully');
        window.location.href = "https://www.upskillmafia.com/success";
      } else {
  ...
  return (
    <div className='form-container'>
      ...
      <div className='form-reg-head1'>(Its recommended to have 4 members it will inrease your chances of winning)</div>
        {currentStep === 1 && (
          <div className='f-page'>
            ...
            {!teamValidation && <p style={{ color: 'white', fontSize: '14px', alignSelf: 'center' }}>Enter Required Fields / Team members between 2-4</p>}
          ...
          <div className='f-page'>
            ...
            <label>
              ...
              <input
                ...
                value={
                  teamMembers.length !== 0 ? teamMembers[currentStep - 2].name : ''
                }
                onChange={(e) =>
            ...
            <label>
              ...
              <input
                ...
                required
                value={
                  teamMembers.length !== 0 ? teamMembers[currentStep - 2].email : ''
                }
                onChange={(e) =>
            ...
            <label>
              ...
              <input
                ...
                value={
                  teamMembers.length !== 0 ? teamMembers[currentStep - 2].number : ''
                }
                onChange={(e) =>
